...
mav_taxi_v_fareSummary_summaryString = format ["<br/>Откуда<t align='right'>%1</t><br/>Куда<t align='right'>%2</t>", [_startPos] call mav_taxi_fnc_nearestLocation, [_endPos] call mav_taxi_fnc_nearestLocation];
