...
switch _mode do {
	...
	case "saveSettings": {
		...
		["InfoTitleOnly",[(getText(missionConfigFile >> "maverick_navigation_cfg" >> "localization" >> "msgSettingsSaved"))]] call toast;
	...
	case "reset": {
		...
		saveProfileNamespace;
		["InfoTitleOnly",[(getText(missionConfigFile >> "maverick_navigation_cfg" >> "localization" >> "msgPositionReset"))]] call toast;
