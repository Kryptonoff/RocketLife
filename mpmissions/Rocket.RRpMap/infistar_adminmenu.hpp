class RscListBox_infiSTAR: RRP_RscListBox
{
	font="PuristaLight";
	sizeEx=0.029999999;
	maxHistoryDelay=1;
...
class RscButton_infiSTAR
{
	...
	colorDisabled[]={0.60000002,0.1,0.30000001,0};
	colorBackground[]={0,0,0,0.80000001};
	colorBackgroundDisabled[]={0,0,0};
	colorBackgroundActive[]={0.15000001,0.34999999,0.55000001,0.69999999};
	colorFocused[]={0.57999998,0.050000001,0,0.69999999};
...
{
	idd=-1341;
	onLoad = "uiNamespace setVariable ['infiSTAR_EDITBOX2',_this select 0]";
	onUnload = "uiNamespace setVariable ['infiSTAR_EDITBOX2',displayNull]";
	movingenable="true";
	class controls
	{
		class RscEditMultiSTAR: RscEdit_infiSTAR_multi
...
{
	idd = -1338;
	onLoad = "uiNamespace setVariable ['infiSTAR_AdminMenu',_this select 0]";
	onUnload = "uiNamespace setVariable ['infiSTAR_AdminMenu',displayNull]";
	movingenable="false";
	controls[]=
	{
		"infi_TXT2",
	...
	class infi_TXT2: RscText_infiSTAR
	{
		...
		colorText[]={1,1,1,0.89999998};
		colorBackground[]={0.56,0.039999999,0.039999999,1};
	};
