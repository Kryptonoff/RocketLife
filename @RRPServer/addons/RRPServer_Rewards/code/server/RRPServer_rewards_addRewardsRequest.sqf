//Example Usage:
// From infistar to player ["addRewardsRequest", ["UID_OF_PLAYER_TARGET", [["ExileScore",1000],["ExileMoney",2000],"Exile_Item_Flag","Exile_Item_SafeKit"]]] call RRPClient_system_send;

// From server to player ["dms_mission", ["UID_OF_PLAYER_TARGET", [["ExileScore",1000],["ExileMoney",2000],"Exile_Item_Flag","Exile_Item_SafeKit"]]] call RRPServer_rewards_addRewardsRequest;
/* 
[
	"__SERVER__", 
	[
...
{	
	...
	[
		...
		[
			[
				format["Выдал: %1",_rewarder],
				[
					format ["**Кому дали:** %1", _targetUID],
					format ["**Награда:** %1", _rewards]
				] joinString "\n",
				"",
				"FF0000",false,"","",[],[]
			]
