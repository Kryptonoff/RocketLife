...
try
{
	...
	[getPlayerUID _player,"vehicle_plate",format ["Изменил номера на %1 ID|%2 Старый %4 - новый %3",_classname,_key, _plate,_curPlate]] call RRPServer_util_logDB;
	...
	["setPlate", _log] remoteExecCall ["RRPClient_garage_responseServer",owner _player];
	[500,"установленные номера"] remoteExecCall ["addXP",_player];
}catch{
	["setPlate", _exception] remoteExecCall ["RRPClient_garage_responseServer",owner _player];
};
true
