...
while {_timeRemaining > 0} do 
{
	...
	_timeRemaining = (_endTime - serverTime) max 0;
	_timer ctrlSetStructuredText (parseText format ["<t align='center' size='0.8' shadow='false' font='RobotoCondensedLight'>%1</t>", [_timeRemaining, "MM:SS"] call BIS_fnc_secondsToString]);
