...
_parameters = _this;
_time = diag_tickTime;
if(DB3_DEBUG) then {format ["selectFull - %1",_parameters] call RRPServer_DB_debug;};
...
if(DB3_DEBUG) then {format ["selectFull - Result Time:%1",(diag_tickTime) - _time] call RRPServer_DB_debug;};
_result select 1
