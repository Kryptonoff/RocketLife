...
["remove",format ["Битва за переработку %1",(enabledCaptures select BattleIndex) select 1],"сервер"] remoteExecCall ["AvalonClient_martiallaw_updateWarPoints",-2];
BattleIndex = -1;
...
format ["endBattle:%1:%2:%3",_gangName,[],_resource] call RRPServer_DB_fireAndForget;
uiSleep 1;
