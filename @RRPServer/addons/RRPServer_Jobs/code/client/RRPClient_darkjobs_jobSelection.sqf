/*
	...
	Filename: 	RRPClient_darkjobs_jobSelection.sqf
...
try 
{
	...
	((findDisplay 7000) displayCtrl 7001) ctrlSetStructuredText parseText format ["<t align='center' size='0.8' color='%2'>Количество темок будет расти с увеличением вашего уровня<br/><br/><t size='1.2'>Доступные темки:<br/></t></t>",profileNamespace getVariable ['GUI_V3_TXT_HTML','#000000']];
...

	{
		...
		_btn ctrlShow true;
	} forEach getArray(missionConfigFile >> "CfgJobs" >> "life_darkjobs_array");
} catch {
