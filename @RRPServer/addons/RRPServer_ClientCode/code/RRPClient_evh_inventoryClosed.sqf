/*
	...
	Filename: 	RRPClient_evh_inventoryClosed.sqf
...
[life_currentContainer,"openedByUnit"] call RRPClient_system_clearGlobalVar;
[life_currentSecondaryContainer,"openedByUnit"] call RRPClient_system_clearGlobalVar;
