/*
	...
	Filename: 	RRPClient_system_addItemToBox.sqf
...
private _itemInformation = [_item] call RRPClient_util_itemDetails;
if (_itemInformation isEqualTo []) exitWith {
	format ["error in RRPClient_system_addItemToBox: undefined item %1",_item] call chat;
};
