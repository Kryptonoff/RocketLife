/*
	...
	Filename: 	RRPClient_system_punishment.sqf
...
switch (_type) do {
    case 1: {//килл в зеленой зоне
    	...
    	"Вы были наказаны за убийство в зеленой зоне. Вы были помещены в тюрьму на 180 минут без возможности выкупа." call chat;
        ...
        ["up",1] call RRPClient_system_updateKarma;
    };
    case 2: {//заход в круг смерти
        ...
        "Вы были наказаны за нарушение правила новой жизни. Вы были помещены в тюрьму на 45 минут без возможности выкупа." call chat;
