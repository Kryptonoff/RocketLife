...
params 
[
	["_builtObj",objNull,[objNull]]
];

if (isNull _builtObj) exitWith { diag_log "Ой, вей, совсем все плохо! buildStore"};
	...
	if !(_builtObj isEqualTo 0) then 
	{
		switch(_dikCode)do
		{
			case 1: 
			{
				...
				["Вы отменили установку магазина"] call hints;
				_handled = true;
			};
			case 71: 
			{
			...
			{
				// systemChat "Поставил";
				[] spawn RRPClient_ltd_placeStoreConfirm;
				_handled = true;
			};
		};
	};
