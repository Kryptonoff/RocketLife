/*
	...
	Filename: 	RRPClient_archeology_nearestPoint.sqf
...
if (EQUAL(_curZone,"")) exitWith {call RRPClient_archeology_clearZone};
...
if !(EQUAL(life_arc_currentZone,_curZone)) then {
	...
	format["Archeology - Current Point: %1",life_arc_currentPoint] call RRPClient_system_log; //точка где и лежит сам КЛАД		
};