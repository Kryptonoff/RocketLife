/*
	...
	Filename: 	RRPClient_delivery_getMission.sqf
...
try{
	...
	_price = [str(life_depo),_to,typeOf _vehicle] call RRPClient_delivery_price;
	...
	_fromTitle = [str(life_depo)] call RRPClient_system_varToStr;
	_toTitle = [_to] call RRPClient_system_varToStr;
	_vehicle SVAR ["cargoDeliver",[str(life_depo),_to,_price],true];
	["SuccessTitleAndText",["Доставка", format ["Вы взяли заказ на доставку груза из %1 в %2. Удачи на дороге!",_fromTitle,_toTitle]]] call toast;
