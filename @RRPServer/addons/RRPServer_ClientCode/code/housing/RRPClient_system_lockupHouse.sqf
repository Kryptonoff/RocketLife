/*
	Filename: 	RRPClient_system_lockupHouse.sqf
...
titleText ["Дом закрывается. Пожалуйста подождите...","PLAIN"];
uiSleep 3;
...
if (!_state) then {
	[_house] call RRPClient_system_lockHouse;
};

titleText ["Дом был заперт.","PLAIN"];