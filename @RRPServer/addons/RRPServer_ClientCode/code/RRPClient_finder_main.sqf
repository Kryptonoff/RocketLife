#define SELF RRPClient_finder_main
...
switch _mode do {
	case "init":{
		...
		//TER_fnc_markerSearch = compileFinal preprocessfilelinenumbers "core\scripts\fn_markersearch.sqf";
