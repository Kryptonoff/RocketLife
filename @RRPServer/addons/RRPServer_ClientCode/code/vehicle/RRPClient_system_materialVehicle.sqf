/*
	...
	Filename: 	RRPClient_system_materialVehicle.sqf
...
format["VehicleMaterial - This: %1",_this] call RRPClient_system_log;
...
if (local _vehicle) then {
	_vehicle SVAR ["Life_VEH_material",_material,true];	
};