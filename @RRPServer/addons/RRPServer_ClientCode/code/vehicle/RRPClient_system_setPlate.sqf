/*
	...
	Filename: 	RRPClient_system_setPlate.sqf
...
switch (true) do {
	case (["ext_Jonzie", (typeOf _vehicle)] call RRPClient_util_xString): {
		_platePath = "\Jonzie_Carpack\Universal_Cars\Number_Plates";
		_plateIndexArray = [1,2,3,4,5,6,7];
	}; 
	case (["ext_ivory", (typeOf _vehicle)] call RRPClient_util_xString): {
