...
if (_ammo isEqualTo "Extremo_Ammo_Swing") exitWith {};
...
private _hit = [(configFile >> "CfgAmmo" >> _ammo >> "hit"), format ["life_suppr_cached_hit_%1", _ammo]] call RRPClient_util_readCacheValues;
