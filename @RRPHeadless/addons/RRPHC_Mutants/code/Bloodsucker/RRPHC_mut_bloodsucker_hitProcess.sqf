...
if ((damage _victim) >= 0.8) then {
	...
	[_victim, 0.25] remoteExecCall ["RRPClient_mut_setDamage",_victim];
...
[_soundCache, [selectRandom["flesh_attack_hit_0", "flesh_attack_hit_1", "bloodsucker_heavy_hit_1"], 60]] remoteExecCall ["say3D",-2];

[{deleteVehicle _this}, _soundCache, 2.5] call CBA_fnc_waitAndExecute;