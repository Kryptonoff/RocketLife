...
if (_uid isEqualTo "" || {_side isEqualTo "error"}) exitWith {}; //Bad.
_query = "";
    ...
    case 4:
        {
            ...
            _value = [_value] call RRPHC_util_tinyIntConverter;
    ...
    case 22:
        {
            ...
            from 0 to count(_value2) - 1 do {
                private _bool = [(_value2 select _i) select 1] call RRPHC_util_tinyIntConverter;
