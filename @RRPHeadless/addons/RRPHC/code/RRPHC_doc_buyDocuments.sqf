...
diag_log format ["RRPHC_doc_buyDocuments ARGS: %1",_this];
...
format["buyDocuments:%1:%2:%3:%4:%5:%6",_docClass,_docName,_docTime,"SYSTEM",_docShop,_ownerUid] call RRPHC_DB_insertSingle;
private _return = format["getDocuments:%1",_ownerUid] call RRPHC_DB_selectFull;
